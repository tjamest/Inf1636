...
public class Movimentacao {
	...
	public static void MovimentacaoNormal(int x, int y, int roll, Color cor, int indice) { 
		...
		for (int i = 0 ; i<roll; i++) {
			...
			else if (auxX > 0 && auxY == 7 && z!= i && cor == Color.RED) {
				// se x >0 e x < 6 e y == 7
			...
			else if (auxX == 7 && auxY > 0  && z!= i && cor == Color.GREEN) {
				// se x == 7 e y >0 e y < 6
			...
			else if (auxX < 14 && auxY == 7 && z!= i && cor == Color.YELLOW) {
				// se y == 7 e x< 14 e x> 8 
			...
			else if (auxY < 14 && auxX == 7 && z!= i && cor == Color.BLUE) {
		...
		if (casaX == 6 && casaY == 7 && cor == Color.RED) {
